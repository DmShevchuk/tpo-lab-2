...
class TestLayer2 {
    ...
    fun initMock() {
        ...
        `when`(mock.sin(-78.4768766159879)).thenReturn(-0.06289817699065442)
        `when`(mock.sin(-5.771033540968432)).thenReturn(
            0.4900540574224449
        )
        `when`(mock.sin(-56.011662071992085)).thenReturn(
            0.5115654472217117
        )
        `when`(mock.sin(-83.63140037147643)).thenReturn(
            -0.9289629066159499
        )
        `when`(mock.sin(-16.575791201423968)).thenReturn(
            0.7629265289664479
        )
        `when`(mock.sin(-71.00935809846433)).thenReturn(
            -0.9481211868155247
        )
        `when`(mock.sin(-40.85448161128262)).thenReturn(
            0.013776678783173079
        )
        `when`(mock.sin(-74.67388110604549)).thenReturn(
            0.6626432209873704
        )
        `when`(mock.sin(-23.654025410872137)).thenReturn(
            0.9957635845222013
        )
        `when`(mock.sin(-44.709579012060615)).thenReturn(
            -0.6648416869850924
        )
        `when`(mock.sin(-96.15609399777273)).thenReturn(
            -0.9435794548493197
        )
        `when`(mock.sin(-24.62991650009137)).thenReturn(
            0.48190255520373504
        )
        `when`(mock.sin(-27.86036822896014)).thenReturn(
            -0.4022431673715233
        )
        `when`(mock.sin(-98.97517933437508)).thenReturn(
            0.9998873408631237
        )
        `when`(mock.sin(-78.44220220246164)).thenReturn(
            -0.09745919141516621
        )
        `when`(mock.sin(-42.65946086963063)).thenReturn(
            0.9694150979937904
        )
        `when`(mock.sin(-13.967126888204206)).thenReturn(
            -0.9855779898660006
        )
        `when`(mock.sin(-9.33697496057539)).thenReturn(
            -0.08769022608379741
        )
        `when`(mock.sin(-62.64111839435503)).thenReturn(
            0.18958030030128345
        )
        `when`(mock.sin(-60.77153431827534)).thenReturn(
            0.8825575163285769
        )
        `when`(mock.sin(-47.20305358212036)).thenReturn(
            0.07908111888193373
        )
        `when`(mock.sin(-75.75130871413687)).thenReturn(
            -0.3457941622172371
        )
        `when`(mock.sin(-78.4768766159879 - periodNum * PERIOD)).thenReturn(
            -0.06289817699052654
        )
        `when`(mock.sin(-5.771033540968432 - periodNum * PERIOD)).thenReturn(
            0.4900540574224715
        )
        `when`(mock.sin(-56.011662071992085 - periodNum * PERIOD)).thenReturn(
            0.5115654472216695
        )
        `when`(mock.sin(-83.63140037147643 - periodNum * PERIOD)).thenReturn(
            -0.9289629066159026
        )
        `when`(mock.sin(-16.575791201423968 - periodNum * PERIOD)).thenReturn(
            0.762926528966476
        )
        `when`(mock.sin(-71.00935809846433 - periodNum * PERIOD)).thenReturn(
            -0.9481211868154794
        )
        `when`(mock.sin(-40.85448161128262 - periodNum * PERIOD)).thenReturn(
            0.013776678783215403
        )
        `when`(mock.sin(-74.67388110604549 - periodNum * PERIOD)).thenReturn(0.6626432209873704)
        `when`(mock.sin(-23.654025410872137 - periodNum * PERIOD)).thenReturn(0.9957635845221842)
        `when`(mock.sin(-44.709579012060615 - periodNum * PERIOD)).thenReturn(-0.6648416869851668)
        `when`(mock.sin(-96.15609399777273 - periodNum * PERIOD)).thenReturn(-0.9435794548492726)
        `when`(mock.sin(-24.62991650009137 - periodNum * PERIOD)).thenReturn(0.4819025552036249)
        `when`(mock.sin(-27.86036822896014 - periodNum * PERIOD)).thenReturn(-0.4022431673714453)
        `when`(mock.sin(-98.97517933437508 - periodNum * PERIOD)).thenReturn(0.9998873408631235)
        `when`(mock.sin(-78.44220220246164 - periodNum * PERIOD)).thenReturn(-0.09745919141509554)
        `when`(mock.sin(-42.65946086963063 - periodNum * PERIOD)).thenReturn(0.9694150979937528)
        `when`(mock.sin(-13.967126888204206 - periodNum * PERIOD)).thenReturn(-0.985577989865996)
        `when`(mock.sin(-9.33697496057539 - periodNum * PERIOD)).thenReturn(-0.08769022608374069)
        `when`(mock.sin(-62.64111839435503 - periodNum * PERIOD)).thenReturn(0.18958030030117004)
        `when`(mock.sin(-60.77153431827534 - periodNum * PERIOD)).thenReturn(0.8825575163286173)
        `when`(mock.sin(-47.20305358212036 - periodNum * PERIOD)).thenReturn(0.07908111888207571)
        `when`(mock.sin(-75.75130871413687 - periodNum * PERIOD)).thenReturn(-0.34579416221735704)
        ...
        `when`(mock.sin(-78.4768766159879 - periodNum * PERIOD + PI / 2)).thenReturn(-0.9980199493653938)
        `when`(mock.sin(-5.771033540968432 - periodNum * PERIOD + PI / 2)).thenReturn(0.8716920447061666)
        `when`(mock.sin(-56.011662071992085 - periodNum * PERIOD + PI / 2)).thenReturn(0.8592443152032513)
        `when`(mock.sin(-83.63140037147643 - periodNum * PERIOD + PI / 2)).thenReturn(-0.37017282197936113)
        `when`(mock.sin(-16.575791201423968 - periodNum * PERIOD + PI / 2)).thenReturn(-0.6464851981284613)
        `when`(mock.sin(-71.00935809846433 - periodNum * PERIOD + PI / 2)).thenReturn(-0.3179091302741778)
        `when`(mock.sin(-40.85448161128262 - periodNum * PERIOD + PI / 2)).thenReturn(-0.9999050970576209)
        `when`(mock.sin(-74.67388110604549 - periodNum * PERIOD + PI / 2)).thenReturn(0.7489352186138398)
        `when`(mock.sin(-23.654025410872137 - periodNum * PERIOD + PI / 2)).thenReturn(0.09195044175687127)
        `when`(mock.sin(-44.709579012060615 - periodNum * PERIOD + PI / 2)).thenReturn(0.7469842911648041)
        `when`(mock.sin(-96.15609399777273 - periodNum * PERIOD + PI / 2)).thenReturn(-0.3311462099835464)
        `when`(mock.sin(-24.62991650009137 - periodNum * PERIOD + PI / 2)).thenReturn(0.8762248154945581)
        `when`(mock.sin(-27.86036822896014 - periodNum * PERIOD + PI / 2)).thenReturn(-0.9155328690458341)
        `when`(mock.sin(-98.97517933437508 - periodNum * PERIOD + PI / 2)).thenReturn(0.015010182593424227)
        `when`(mock.sin(-78.44220220246164 - periodNum * PERIOD + PI / 2)).thenReturn(-0.9952395219286352)
        `when`(mock.sin(-42.65946086963063 - periodNum * PERIOD + PI / 2)).thenReturn(0.24542690924376084)
        `when`(mock.sin(-13.967126888204206 - periodNum * PERIOD + PI / 2)).thenReturn(0.16922182450819004)
        `when`(mock.sin(-9.33697496057539 - periodNum * PERIOD + PI / 2)).thenReturn(-0.9961477923729029)
        `when`(mock.sin(-62.64111839435503 - periodNum * PERIOD + PI / 2)).thenReturn(0.9818652197412778)
        `when`(mock.sin(-60.77153431827534 - periodNum * PERIOD + PI / 2)).thenReturn(-0.4702044559255917)
        `when`(mock.sin(-47.20305358212036 - periodNum * PERIOD + PI / 2)).thenReturn(-0.9968681841831548)
        `when`(mock.sin(-75.75130871413687 - periodNum * PERIOD + PI / 2)).thenReturn(0.9383103950052911)
        ...
        `when`(mock.sin(-1.9999999999995866 - periodNum * PERIOD)).thenReturn(-0.9092974268258066)
        `when`(mock.sin(-1.571 - periodNum * PERIOD)).thenReturn(-0.9999999792586565)
        `when`(mock.sin(-3.763099999999999 - periodNum * PERIOD)).thenReturn(0.5822612967594886)
        `when`(mock.sin(-1.9999999999995866 - periodNum * PERIOD + PI / 2)).thenReturn(-0.41614683654683454)
        `when`(mock.sin(0.0 - periodNum * PERIOD + PI / 2)).thenReturn(0.9999999999999116)
        `when`(mock.sin(-1.571 - periodNum * PERIOD + PI / 2)).thenReturn(-2.0367320372699147E-4)
        `when`(mock.sin(-3.763099999999999 - periodNum * PERIOD + PI / 2)).thenReturn(-0.8130017111267858)

        `when`(mock.sin(-0.8867 - periodNum * PERIOD)).thenReturn(-0.77499046045734)
        `when`(mock.sin(-3.529 - periodNum * PERIOD)).thenReturn(0.37778917123081346)
        `when`(mock.sin(-5.724 - periodNum * PERIOD)).thenReturn(0.5304957690606096)
        `when`(mock.sin(-5.913 - periodNum * PERIOD)).thenReturn(0.3617881927059663)
        `when`(mock.sin(-3.14011 - periodNum * PERIOD)).thenReturn(-0.0014826530463084486)
        `when`(mock.sin(-4.7124 - periodNum * PERIOD)).thenReturn(0.999999999939195)
        `when`(mock.sin(-0.8867 - periodNum * PERIOD+ PI/2)).thenReturn(0.6319729315413316)
        `when`(mock.sin(-3.529 - periodNum * PERIOD+ PI/2)).thenReturn(-0.9258916470627655)
        `when`(mock.sin(-5.724 - periodNum * PERIOD+ PI/2)).thenReturn(0.8476875833754904)
        `when`(mock.sin(-5.913 - periodNum * PERIOD+ PI/2)).thenReturn(0.9322603196635392)
        `when`(mock.sin(-3.14011 - periodNum * PERIOD+ PI/2)).thenReturn(-0.9999989008694107)
        `when`(mock.sin(-4.7124 - periodNum * PERIOD+ PI/2)).thenReturn(1.1019615487858221E-5)
    }


    fun printValues() {
        val periodNum = 200;
        val bf = BasicFunctions();


        println(bf.sin(-0.8867 - periodNum * PERIOD));
        println(bf.sin(-3.529 - periodNum * PERIOD));
        println(bf.sin(-5.724 - periodNum * PERIOD));
        println(bf.sin(-5.913 - periodNum * PERIOD));
        println(bf.sin(-3.14011 - periodNum * PERIOD));
        println(bf.sin(-4.7124 - periodNum * PERIOD));
        println(bf.sin(-0.8867 - periodNum * PERIOD+ PI/2));
        println(bf.sin(-3.529 - periodNum * PERIOD+ PI/2));
        println(bf.sin(-5.724 - periodNum * PERIOD+ PI/2));
        println(bf.sin(-5.913 - periodNum * PERIOD+ PI/2));
        println(bf.sin(-3.14011 - periodNum * PERIOD+ PI/2));
        println(bf.sin(-4.7124 - periodNum * PERIOD+ PI/2));
    }
